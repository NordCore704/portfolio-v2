...
const FormText = () => {
  ...
  return (
    <motion.div className="h-[50%] w-full md:w-[50%] md:h-full flex flex-col gap-8 justify-center items-center p-5"  transition={{
      ease: "easeInOut",
      duration: 2,
      type: "spring",
      delay: 0,
    ...
    initial="init"
    ref={ref}>
      <p className="font-semibold text-2xl text-scheme-white md:text-left text-center md:self-start self-center">
