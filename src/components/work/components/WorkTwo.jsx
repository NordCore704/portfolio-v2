...
const WorkTwo = () => {
  ...
  return (
    <div className="p-5 md:w-[50%] md:h-[100dvh] w-full h-[50%] flex flex-col gap-8  text-scheme-white">
      ...
      {projects.map((item, index) => (
        ...
        >
          <details className="group border-b">
            <summary className="flex items-center gap-1 marker:content-none hover:cursor-pointer hover:text-scheme-yellow font-semibold justify-between">
              {item.projectName}{" "}
            ...
            <article className="flex flex-col gap-1 px-2">
              <a
                ...
                className="hover:text-scheme-yellow flex items-center gap-1"
              >
